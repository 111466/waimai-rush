...
function M.Init()
    ...
    M.powerupBase = M.CreatePBRMaterial(Color(0.18, 0.23, 0.32, 1.0), 0.1, 0.55)
    M.powerupShield = M.CreatePBRMaterial(Color(0.30, 0.64, 1.0, 1.0), 0.2, 0.35)
    M.powerupClock = M.CreatePBRMaterial(Color(1.0, 0.78, 0.22, 1.0), 0.15, 0.4)
