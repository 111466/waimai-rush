...
M.CONFIG = {
    ...
    -- 跑道参数
    ROAD_GRID_SIZE = 8,
    ROAD_BLOCK_BASE = 74.0,
    ROAD_BLOCK_JITTER = 14.0,
    ...
    ORDER_PICKUP_REACHABLE_MIN_HOPS = 1,
    ORDER_PICKUP_REACHABLE_MAX_HOPS = 3,
    ORDER_PICKUP_MIN_DISTANCE_BETWEEN = 36.0,
    ORDER_PICKUP_MIN_WORLD_DISTANCE = 42.0,
    ORDER_PICKUP_LONGITUDINAL_THRESHOLD = 2.4,
    ORDER_PICKUP_LATERAL_THRESHOLD = 1.15,
    ...
    -- 局内道具
    POWERUP_POOL_SIZE = 8,
    POWERUP_INITIAL_SPAWN_DISTANCE = 60.0,
    ...
    RIDER_ORDER_TYPE_ORDER = { "normal", "nearby", "rush", "long", "fragile" },
